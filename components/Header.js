    ...
    <>
      <header className="fixed inset-x-0 z-50 shadow-2-6 bg-brown-200 border-b-2 border-b-brown-600">
        <div className="container mx-auto px-10 h-72 flex justify-between items-center">
          <nav>
            <a
              className="text-shadow-0-4-8 font-dancingscript text-26 select-none md:text-28 lg:text-32 font-bold text-red-400"
              href="#"
            >
              Aline Balas Gourmet
            </a>
          ...
          <div>
            ...
            >
              ...
              >
                <li className="select-none transition duration-500 text-shadow-0-4-8 hover:text-red-200 cursor-pointer">
                  Home
                </li>
                <li className="select-none transition duration-500 text-shadow-0-4-8 hover:text-red-200 cursor-pointer">
                  Cardápio
